...
Java_iu3_rpo_fclient_MainActivity_stringFromJNI(
        JNIEnv* env,
...
Java_iu3_rpo_fclient_MainActivity_initRng(
        JNIEnv *env,
        jclass MainActivity ) {
...
Java_iu3_rpo_fclient_MainActivity_randomBytes(JNIEnv *env, jclass MainActivity, jint no) {
...
extern "C" JNIEXPORT jbyteArray JNICALL
Java_iu3_rpo_fclient_MainActivity_encrypt(JNIEnv *env, jclass, jbyteArray key, jbyteArray data)
{
...
extern "C" JNIEXPORT jbyteArray JNICALL
Java_iu3_rpo_fclient_MainActivity_decrypt(JNIEnv *env, jclass, jbyteArray key, jbyteArray data)
{
    jsize ksz = env->GetArrayLength(key);
    jsize dsz = env->GetArrayLength(data);
